...
public final class Dialogs {
    ...
    public static Optional<String> text(Window owner, String title, String header, String initial) {
        ...
        VBox content = new VBox(10, h, tip, spacer(2), field, input);
    ...
    public static Optional<QuestionInput> question(Window owner, String title, String question, String answer) {
        ...
        Label qLabel = new Label("问题 / 需要记住的知识点");
        qLabel.getStyleClass().add("field-caption");
        ...
        Label aLabel = new Label("答案 / 学习笔记");
        aLabel.getStyleClass().add("field-caption");
        ...
        VBox qBox = new VBox(6, qLabel, q, qCount);
        VBox aBox = new VBox(6, aLabel, a, aCount);
        VBox.setVgrow(a, Priority.ALWAYS);

        VBox content = new VBox(12, h, tip, divider(), qBox, aBox);
        content.setPadding(new Insets(2));
        VBox.setVgrow(aBox, Priority.ALWAYS);
        d.getDialogPane().setContent(content);
        d.getDialogPane().setPrefWidth(760);
        d.getDialogPane().setPrefHeight(680);
        d.setResizable(true);
